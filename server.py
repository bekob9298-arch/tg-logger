...
# @BotFather'dan aldığın yeni ve temiz tokeni buraya yaz
TELEGRAM_TOKEN = '8901753461:AAF_kHbFJha1rnifBtGybuSBwvrKHKm-r0U'
...
def callback_inline(call):
    # Bu kısmı Render'a yükledikten sonra Render'ın bize vereceği link ile değiştireceğiz
    hedef_link = "http://localhost:5000" 
